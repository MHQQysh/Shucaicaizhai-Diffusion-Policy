...
from arm.vibration_suppression import ZVShaper


class TestZVShaper(TestCase):
    def test_zv_shaper(self):
        ...
        if open_shaper:
            trajectory1 = zv_shaper.shape(trajectory1)
            trajectory2 = zv_shaper.shape(trajectory2)
            trajectory3 = zv_shaper.shape(trajectory3)
            trajectory4 = zv_shaper.shape(trajectory4)
            trajectory5 = zv_shaper.shape(trajectory5)
            trajectory6 = zv_shaper.shape(trajectory6)
