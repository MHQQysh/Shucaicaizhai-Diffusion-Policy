...
class TestShaper(TestCase):
    def test_zv_shaper(self):
        open_shaper = True
        ...
        omega_d = 2 * np.pi / Td
        shaper = ZVShaper(omega_d, zeta, model.opt.timestep)
        ...
        if open_shaper:
            trajectory1 = shaper.shape(trajectory1)
            trajectory2 = shaper.shape(trajectory2)
            trajectory3 = shaper.shape(trajectory3)
            trajectory4 = shaper.shape(trajectory4)
            trajectory5 = shaper.shape(trajectory5)
            trajectory6 = shaper.shape(trajectory6)
    ...
    def test_zvd_shaper(self):
        ...
        omega_d = 2 * np.pi / Td
        shaper = ZVDShaper(omega_d, zeta, model.opt.timestep)
    ...
    def test_no_delay_shaper(self):
        ...
        if open_shaper:
            trajectory1 = no_delay_shaper.shape(trajectory1)
            trajectory2 = no_delay_shaper.shape(trajectory2)
            trajectory3 = no_delay_shaper.shape(trajectory3)
            trajectory4 = no_delay_shaper.shape(trajectory4)
            trajectory5 = no_delay_shaper.shape(trajectory5)
            trajectory6 = no_delay_shaper.shape(trajectory6)
