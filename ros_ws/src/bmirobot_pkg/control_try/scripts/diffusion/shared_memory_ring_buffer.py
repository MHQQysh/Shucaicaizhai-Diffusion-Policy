...
from diffusion.shared_memory_util import ArraySpec, SharedAtomicCounter
...
class SharedMemoryRingBuffer:
    ...
    def __init__(self, 
        ...
        #print(self.array_specs)
        self.counter = counter
        self.shared_arrays = shared_arrays
        #print(self.shared_arrays)
    ...
    def put(self, data: Dict[str, Union[np.ndarray, numbers.Number]], wait: bool=True):
        ...
        self.counter.add(1)
        #print(self.counter.load())

    def _allocate_empty(self, k=None):  # empty: single; others:number
        result = dict()
    ...
    def get(self, out=None) -> Dict[str, np.ndarray]:     # single--None, multi--number
        if out is None:
    ...
    def get_last_k(self, k:int, out=None) -> Dict[str, np.ndarray]:  # k buffers
