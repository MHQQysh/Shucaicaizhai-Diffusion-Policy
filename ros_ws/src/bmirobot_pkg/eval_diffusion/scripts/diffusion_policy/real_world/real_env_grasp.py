...
from diffusion_policy.real_world.rtde_interpolation_controller_gazebo import RTDEInterpolationController
from diffusion_policy.real_world.multi_realsense_gazebo import MultiRealsense, SingleRealsense
...
class RealEnv:
    def __init__(self,
                 ...
                 video_capture_resolution=(640,480),  #  (1280, 720)
                 # saving params
