...
class RTDEInterpolationController(mp.Process):
    ...
    def run(self):
        ...
        try:
            if self.verbose:
                print(f"[RTDEPositionalController] Connect to robot: {00}")
            ...
            while keep_running:
                ...
                if self.verbose:
                    print(f"[RTDEPositionalController] Actual frequency {00}")
            ...
            if self.verbose:
                print(f"[RTDEPositionalController] Disconnected from robot: {00}")
