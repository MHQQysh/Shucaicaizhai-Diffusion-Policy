    ...
    def run(self):
        ...
        try:
            ...
            while not self.stop_event.is_set():
                ...
                #cv2.imshow('default',np.asarray(frame['data']))
                #cv2.waitKey(1)
                # print(frame.shape)
                ...
                if self.enable_color:
                    ...
                    data['color'] = np.asarray(
                        frame['data'])  # !!    set two option: if it is 1,get data1; if it is 2,get data2;
