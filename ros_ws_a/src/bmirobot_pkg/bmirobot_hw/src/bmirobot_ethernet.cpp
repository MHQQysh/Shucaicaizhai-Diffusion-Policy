...
main(int argc, char **argv)
{
  ...
  ros::Publisher Mt_fdctrpub = n.advertise<bmirobot_msg::Robot_fdctr>("MT_fdctr", 100);
  ros::Publisher Mt_fdstatuspub = n.advertise<bmirobot_msg::Robot_fdstatus>("MT_fdstatus", 100);
