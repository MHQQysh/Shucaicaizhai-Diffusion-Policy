...
class SingleRealsense(mp.Process):
    ...
    # ========= user API ===========
    def set_color_option(self, option: rs.option, value: float):     #  rgb_raw,option
    ...
    def run(self):
        ...
        try:
            ...
            while not self.stop_event.is_set():
                ...
                data['camera_capture_timestamp'] = frameset.get_timestamp() / 1000   # topic
                if self.enable_color:
                    color_frame = frameset.get_color_frame()        # about color/image !!
                    data['color'] = np.asarray(color_frame.get_data())       # !!    set two option: if it is 1,get data1; if it is 2,get data2;
