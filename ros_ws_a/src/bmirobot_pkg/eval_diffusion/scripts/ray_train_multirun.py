...
def main(config_name, config_dir, seeds, monitor_key, ray_address, 
    ...
    with hydra.initialize(
        ...
        swanlab_group_id = swanlab.util.generate_id()
        ...
        monitor_command_args = [
            ...
            '--group', swanlab_group_id  #wandb_group_id
        ]
        ...
        for i, seed in enumerate(seeds):
            ...
            swanlab_name = name_base+ f'_train_{i}'
            #wandb_name = name_base + f'_train_{i}'
            #wandb_run_id = wandb_group_id + f'_train_{i}'
            swanlab_run_id = swanlab_group_id + f'_train_{i}'
            ...
            this_command_args.extend([
                ...
                f'logging.name={swanlab_name}',   # wandb_name
                f'logging.id={swanlab_run_id}',   #wandb_run_id
                f'logging.group={swanlab_group_id}',  # wandb_group_id
