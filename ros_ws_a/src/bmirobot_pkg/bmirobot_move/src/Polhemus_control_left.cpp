...
int main(int argc, char **argv)
{
	...
	ros::Subscriber sub = n.subscribe("/bmirobot/PointsPR", 1000, PointsPRCallback);
  	grasp_joint_pub = n.advertise<std_msgs::Float64MultiArray>( "/bmirobot/left_group_hand_controller/command", 0 );
  	arm_joint_pub = n.advertise<std_msgs::Float64MultiArray>( "/bmirobot/left_group_controller/command", 0 );
